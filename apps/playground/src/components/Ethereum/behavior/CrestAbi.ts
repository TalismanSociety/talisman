export const CrestAbi = [
  ...
  { inputs: [], name: "mint", outputs: [], stateMutability: "nonpayable", type: "function" },
  {
    inputs: [
      { internalType: "address", name: "to", type: "address" },
      { internalType: "uint96", name: "dna", type: "uint96" },
    ],
    name: "mintSpecific",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  {
    inputs: [{ internalType: "address", name: "_auctionHouse", type: "address" }],
  ...
  {
    inputs: [{ internalType: "address", name: "_founders", type: "address" }],
    name: "setFounders",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
