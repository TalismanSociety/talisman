...
const DATA_TO_ENCRYPT = "data to encrypt yeet yeet yeeeeeet. this is a loooooong message blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah"
...
export const Sumi = () => {
  ...
  const handleEncrypt = useCallback(async (data: string | undefined) => {
    setError(undefined)
  ...
  const handleDecrypt = useCallback(async (data: string | undefined) => {
    setError(undefined)
