...
const AccountButton: FC<{ option: AccountAccountOption }> = ({ option }) => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 left-6 flex h-14.75 flex-col justify-center">
        <div className="relative size-16 text-xl">
  ...
  return (
    <div className="flex w-full flex-col gap-4">
      ...
      {hasAnyAccount && !portfolioOptions.length && !watchedOptions.length && (
        <div className="flex h-25 items-center justify-center rounded-sm bg-grey-900 text-body-disabled text-xs opacity-50">
          {t("No accounts found")}
        </div>
      )}
    </div>
