...
const AssetRowContent: FC<{ tokenId: TokenId; assets: DiscoveredBalance[] }> = ({
  ...
  return (
    <div className="grid h-32 grid-cols-[1fr_1fr_1fr_6.25rem] items-center gap-x-8 rounded-sm bg-grey-900 px-8">
...
const AssetTable: FC = () => {
  ...
  return (
    <div className="flex w-full min-w-[28.125rem] flex-col gap-4 text-left text-base text-body">
      <div className="grid grid-cols-[1fr_1fr_1fr_6.25rem] gap-x-8 px-8 font-normal text-body-disabled text-sm">
        <div>{t("Asset")}</div>
        <div>{t("Network")}</div>
