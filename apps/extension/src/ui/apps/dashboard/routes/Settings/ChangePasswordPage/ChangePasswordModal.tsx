...
export const ChangePasswordModal = ({
  ...
  return (
    <Modal isOpen={isOpen}>
      <ModalDialog title={t("Changing password")} centerTitle className="w-[25rem]">
        <ProcessAnimation status="processing" className="my-8 h-[8.75rem]" />
        <div className="flex flex-col gap-5">
          ...
          <div className="flex items-center gap-6 rounded bg-alert-warn/10 p-4 px-6 text-alert-warn text-sm">
            <AlertTriangleIcon className="shrink-0 text-alert-warn text-lg" />
            <div>
              {t(
