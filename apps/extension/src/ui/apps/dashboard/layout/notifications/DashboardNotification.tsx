...
export const DashboardNotification = ({
  ...
  return (
    <div className="mb-12 flex w-full items-center gap-6 rounded border border-white bg-grey-900 p-8 text-base">
      {icon && (
        <div className="flex flex-col justify-center text-[3.8rem] text-primary">{icon}</div>
      )}
      ...
      {action && (
        <button
          type="button"
          className="!text-sm h-[3rem] whitespace-nowrap rounded-xl bg-primary px-8 py-2 text-black"
