...
export const MigrationProgress = () => {
  ...
  return (
    ...
    >
      <div className="flex h-[37.5rem] w-[25rem] animate-fade-in-slow flex-col items-center justify-between overflow-hidden p-8">
        <div className="flex h-[16.75rem] flex-col items-center justify-center gap-24 pt-4">
          <TalismanHandIcon
        ...
        <div className="flex h-[16.75rem] max-h-[16.75rem] w-full flex-col items-center justify-center gap-12">
