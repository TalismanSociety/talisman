...
export const AssetDiscoveryPopupAlert = () => {
  ...
  return (
    <>
      <div className="h-6 shrink-0">{/* push bottom nav up */}</div>
      <div className="bg-grey-800 absolute bottom-0 left-0 flex h-16 w-full shrink-0 items-center gap-4 px-12 text-base">
