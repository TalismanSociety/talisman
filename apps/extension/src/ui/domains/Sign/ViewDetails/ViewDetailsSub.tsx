...
import {
  getTxHelper,
  type SignerPayloadJSON as TxUtilsSignerPayloadJSON,
} from "@polkadot-api/tx-utils"
...
const useDecodedTxInput = () => {
  ...
  return useMemo(() => {
    try {
      ...
      const { input, blockNumber } = fromPjsToInputRaw(payload as TxUtilsSignerPayloadJSON)
