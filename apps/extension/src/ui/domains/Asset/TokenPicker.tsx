    ...
    <Tooltip placement="bottom-end">
      <TooltipTrigger asChild>
        <button
          type="button"
          onClick={onClick}
          className="flex size-[2.875rem] shrink-0 items-center justify-center rounded-sm border border-transparent bg-grey-800 text-body-secondary hover:bg-grey-750 focus-visible:border-grey-600"
        >
          {selectedNetworkId ? (
