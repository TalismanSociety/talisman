...
/** The sn45 api only has mainnet data: never query it for other networks, their data is simply unavailable */
const useIsSn45Enabled = () => useTaoDashboardNetwork().isMainnet
