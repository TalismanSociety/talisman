...
import type { AlphaFlow, FlowTotals } from "./types"
...
export const FlowChartHeader: FC<FlowChartHeaderProps> = ({
  totals,
  alphaFlow,
  emissionPercent,
  dailyEmissions,
  ...
  <div className="flex flex-wrap items-start justify-between gap-4 p-6 pb-2">
    ...
    <div>
      <div className="flex items-baseline gap-2">
        <span className={cn("font-bold text-3xl", totals.net >= 0 ? "text-white" : "text-red-500")}>
          {totals.net >= 0 ? "+" : ""}
    ...
    <div className="flex flex-wrap items-start gap-6 text-sm">
      ...
      <div className="flex flex-col">
        ...
        <div className="flex flex-col">
          <span className="font-medium text-green-500">
            {formatAlpha(alphaFlow.alphaIn)} <span className="text-body-disabled text-xs">In</span>
          </span>
          <span className="font-medium text-red-500">
