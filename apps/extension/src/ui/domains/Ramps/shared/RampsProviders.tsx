...
const RampsProviderButtonSkeleton: FC<RampsProviderPropsLoading> = ({ provider }) => (
  <div className="flex h-23 flex-col justify-between gap-8 rounded border border-grey-700 p-6 text-left text-body-disabled leading-paragraph">
    <div className="flex justify-between">
      <div className="flex flex-col gap-2">
...
const RampsProviderButtonError: FC<RampsProviderPropsError> = ({
  ...
  <div className="flex h-23 flex-col justify-between gap-8 rounded border border-grey-700 p-6 text-left text-body-secondary leading-paragraph">
    <div className="flex justify-between">
      <div className="flex flex-col gap-2">
