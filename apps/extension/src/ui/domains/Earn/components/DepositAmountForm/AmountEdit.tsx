...
//       <div className="text-alert-error flex items-center justify-center gap-2 pt-[0.5rem] !text-xs font-normal">
//         <AlertCircleIcon className="text-alert-error inline-block h-6 w-6 align-text-top" />
