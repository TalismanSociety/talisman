...
export const useEarnDepositTransactionEth = (_props: UseEarnDepositTransaction) => {
  return null
  // const [isLocked, setIsLocked] = useState(false)
  // // const { account, tokenId, amount } = useDepositWizard()
  // const token = useToken(tokenId)
  // const balance = useBalance(address as string, tokenId as string)
  ...
  //   // }
  // }, [token, address, allTransactions, yieldError])
