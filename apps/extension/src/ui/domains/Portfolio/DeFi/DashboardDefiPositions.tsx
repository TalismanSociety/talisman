...
const DefiPositionRow: FC<{
  ...
  if (position.id === "SHIMMER")
    return (
      ...
      <FadeIn className="flex h-[4.125rem] w-full items-center gap-8 rounded-sm bg-grey-850 px-8">
  ...
  return (
    <button
      type="button"
      className={classNames(
        "flex h-[4.125rem] w-full items-center gap-8 overflow-hidden rounded-sm bg-grey-850 px-8 hover:bg-grey-800"
      )}
