...
const DefiPositionActionRow: FC<{ position: DefiPosition }> = ({ position }) => {
  return (
    <div className="flex h-[4.125rem] w-full items-center gap-8 overflow-hidden rounded border-transparent bg-grey-800 px-8">
      ...
      <div className="flex grow flex-col justify-center gap-2 overflow-hidden pr-8">
        <div className="flex grow items-center gap-3">
          <div className="truncate font-bold text-body">{position.name}</div>
        </div>
  ...
  return (
    <div className="rounded-sm bg-black-secondary">
      <div className="flex h-24 w-full items-center">
        <div className="px-8 font-bold text-base text-white">
...
const DefiPositionItemRow: FC<{
  ...
  return (
    <div className={"flex h-[4.125rem] w-full items-center gap-8 overflow-hidden px-8"}>
      ...
      <div className="flex w-full grow flex-col gap-2 overflow-hidden">
        ...
        <div className="flex w-full items-center justify-between gap-8 overflow-hidden font-normal text-body-secondary">
...
const DefiPositionBreadcrumb: FC<{ position: DefiPosition }> = ({ position }) => {
  ...
  const items = useMemo(() => {
    return [
      ...
      {
        label: <div className="font-bold text-body">{position.name}</div>,
        onClick: undefined,
      },
    ]
...
const DefiPositionHeader: FC<{ position: DefiPosition }> = ({ position }) => {
  ...
  return (
    <div className="flex h-40 w-full items-center justify-between rounded bg-grey-850 px-8 text-base text-body-secondary">
