...
export const AssetRowStakingReminderWrapper = ({
  ...
  const { showTokenStakingBanner, dismissStakingBanner, getStakingMessage } = useStakingBanner()
  ...
  const handleDismissStakingBanner = useCallback(() => {
    ...
    const chainId =
      unsafeChainId && isStakingSupportedChain(unsafeChainId) ? unsafeChainId : undefined
