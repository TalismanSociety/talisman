              ...
              <FadeIn>
                <div className="absolute top-0 left-0 flex h-full w-full flex-col items-center justify-center bg-black/70">
                  ...
                  <div className="relative mx-auto flex w-[calc(100%-0.8rem)] flex-col items-center rounded bg-black-tertiary px-4 py-8">
                    ...
                    <p className="pb-8 text-grey-400 text-sm">
                      <Trans t={t}>
                    ...
                    <div className="mb-6 flex w-full items-center justify-between rounded-lg border border-grey-700 p-4">
                      <div className="flex items-center gap-4">
                        ...
                        />
                        <div>
                          <p className="!leading-none mb-2 font-semibold text-sm">
