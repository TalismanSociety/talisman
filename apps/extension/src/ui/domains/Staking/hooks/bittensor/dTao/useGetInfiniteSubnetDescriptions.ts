...
const fetchSubnetDescriptions = async ({ pageParam = 1 }) => {
  const { data } = await axios.get<SubnetApiDescriptionsResponse>(
    `${TAOSTATS_BASE_PATH}/api/subnet/description/v1`,
    {
...
export const initialData: SubnetApiDescriptionsResponse = {
  ...
  data: [
    ...
    },
    {
      ...
      name: "Apex",
      description:
        "This Subnet defines an incentive mechanism to create a distributed conversational AI.",
    ...
    },
    {
      ...
      hw_requirements:
        "https://github.com/inference-labs-inc/omron-subnet?tab=readme-ov-file#run-the-miner",
    ...
    },
    {
      ...
      image_url:
        "https://github.com/amedeo-gigaver/infinite_games/raw/main/docs/infinite-games.jpeg",
    },
    {
      netuid: 7,
      bittensor_id: "eta",
    ...
    },
    {
      ...
      hw_requirements:
        "https://github.com/taoshidev/proprietary-trading-network/blob/main/docs/miner.md",
    ...
    },
    {
      ...
      hw_requirements:
        "https://github.com/impel-intelligence/dippy-bittensor-subnet/blob/main/min_compute.yml",
      github: "https://github.com/impel-intelligence/dippy-bittensor-subnet",
      image_url:
        "https://github.com/impel-intelligence/dippy-bittensor-subnet/raw/main/assests/banner.png",
    },
    {
      netuid: 12,
      bittensor_id: "mu",
      ...
      image_url:
        "https://github.com/backend-developers-ltd/ComputeHorde/raw/master/ComputeHorde.png",
    },
    {
      netuid: 13,
      bittensor_id: "nu",
      ...
      hw_requirements:
        "https://github.com/macrocosm-os/data-universe/blob/main/docs/miner.md#system-requirements",
    ...
    },
    {
      ...
      hw_requirements:
        "https://github.com/404-Repo/three-gen-subnet?tab=readme-ov-file#hardware-requirements",
    ...
    },
    {
      ...
      image_url:
        "https://github.com/omegalabsinc/omegalabs-anytoany-bittensor/raw/main/galactic_a2a.png",
    },
    {
      netuid: 22,
      bittensor_id: "chi",
    ...
    },
    {
      ...
      hw_requirements:
        "https://docs.taostats.io/docs/subnet-23-niche-image#setup-instructions-for-miners",
    ...
    },
    {
      ...
      hw_requirements:
        "https://github.com/omegalabsinc/omegalabs-bittensor-subnet/blob/main/min_compute.yml",
      github: "https://github.com/omegalabsinc/omegalabs-bittensor-subnet",
      image_url:
        "https://github.com/omegalabsinc/omegalabs-bittensor-subnet/raw/main/docs/galacticlandscape.png",
    },
    {
      netuid: 25,
      bittensor_id: "alef",
    ...
    },
    {
      ...
      image_url:
        "https://github.com/Bettensor/bettensor/raw/main/docs/assets/bettensor-twitter-header.jpg",
    },
    {
      netuid: 31,
      bittensor_id: "zayin",
    ...
    },
    {
      ...
      hw_requirements:
        "https://github.com/autoppia/autoppia_web_agents_subnet/blob/main/min_compute.yml",
    ...
    },
    {
      ...
      name: "Finetuning",
      description:
        "The Finetuning subnet 37 rewards miners for fine-tuning Large Language Models (LLMs).",
    ...
    },
    {
      ...
      name: "Gen42 - Rizzo",
      description:
        "Gen42 leverages the Bittensor network to provide decentralized code generation services. ",
      hw_requirements: "",
    ...
    },
    {
      ...
      image_url:
        "https://github.com/condenses/neural-condense-subnet/raw/main/assets/images/condense-main.png",
    },
    {
      netuid: 48,
      bittensor_id: "",
