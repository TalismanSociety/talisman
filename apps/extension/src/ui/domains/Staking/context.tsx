...
// } from "@core/domains/staking/helpers"
...
export const useStakingBanner = () => {
  ...
  return {
    ...
    showStakingBanner: (ok: any) => false,
    // eslint-disable-next-line @typescript-eslint/no-unused-vars, @typescript-eslint/no-explicit-any
    showTokenStakingBanner: (ok: any) => false,
    // eslint-disable-next-line @typescript-eslint/no-unused-vars, @typescript-eslint/no-explicit-any
    dismissStakingBanner: (ok?: any) => {},
    // eslint-disable-next-line @typescript-eslint/no-unused-vars, @typescript-eslint/no-explicit-any
    getStakingMessage: (ok: any) => undefined,
    // eslint-disable-next-line @typescript-eslint/no-unused-vars, @typescript-eslint/no-explicit-any
    getBannerColours: (ok: any) => undefined,
  }
}
