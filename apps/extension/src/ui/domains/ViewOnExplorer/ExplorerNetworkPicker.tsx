...
const NetworkRow: FC<{ network: Network; onClick: () => void }> = ({ network, onClick }) => {
  return (
    <button
      type="button"
      onClick={onClick}
      className="flex h-32 w-full items-center gap-6 px-12 text-body-secondary hover:bg-grey-800 hover:text-body"
    >
      ...
      <div className="flex grow flex-col gap-2 overflow-hidden text-left">
        <div className="truncate text-body">{network.name}</div>
        <div className="truncate text-body-secondary text-xs">{network.blockExplorerUrls[0]}</div>
      </div>
  ...
  return (
    <div id="copy-address-modal" className="flex h-full w-full flex-col overflow-hidden bg-black">
      <div className="flex h-32 w-full shrink-0 items-center px-12">
        ...
        <div className="grow text-center text-body-secondary">{t("View on explorer")}</div>
      ...
      <div className="flex grow flex-col overflow-hidden">
        ...
        <ScrollContainer className="scrollable h-full w-full grow overflow-x-hidden border-grey-700 border-t bg-black-secondary">
          ...
          {!networks.length && (
            <div className="flex h-32 items-center px-12 text-body-secondary">
