...
// import { BehaviorSubject, combineLatest, debounceTime, map, mergeMap } from "rxjs"
...
// export const portfolioAccount$ = new BehaviorSubject<AccountJsonAny | undefined>(undefined)
...
// export const networkFilter$ = new BehaviorSubject<NetworkOption | undefined>(undefined)
...
//   portfolioGlobalData$,
//   networkFilter$,
//   portfolioSelectedAccounts$]).pipe(map(([ {
//     hydrate,
//     tokens,
//     chains,
//     evmNetworks,
...
//     portfolioBalances,
//     isInitialising,
//   } , networkFilter, selectedAccounts]) => {
...
// // TODO debounce
// const portfolioSearch$ = new BehaviorSubject<string>("")

// export const [usePortfolio, portfolio$] = bind(combineLatest([portfolioBase$, portfolioSearch$]).pipe(
//   map(([base, search]) => {
