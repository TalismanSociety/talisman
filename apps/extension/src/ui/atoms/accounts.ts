...
import { AccountCategory, accountsMap$, getAccountsByCategory$ } from "@ui/state"

//export {AccountCategory } from "@ui/state"
...
// export const accountsByAddressAtomFamily = atomFamily(
//   (address: Address | null | undefined) => atomWithObservable(() => getAccountByAddress$(address))
...
export const accountsByCategoryAtomFamily = atomFamily(
