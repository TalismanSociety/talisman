...
import type { SolNetwork, Token, TokenType } from "@talismn/chaindata-provider"
...
export const testSubscribeBalancesSol = async (
  ...
  const mod = BALANCE_MODULES.find((m) => m.type === opts.module && m.platform === "solana")
  if (!mod) {
