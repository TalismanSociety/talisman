...
setupModule(NETWORK_CONFIG, "substrate-assets")
  .then(async (setup) => {
    log.log()
    log.log("=".repeat(80))
    log.log("Running subscribeBalances thread blocking test (substrate-assets)...")
    log.log("=".repeat(80))
    log.log()
