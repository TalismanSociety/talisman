...
module.exports = {
  content: ["./src/**/*.{html,ts,tsx,svg}", "./public/*.html"],
  theme: {
    colors: {
      initial: "initial",
      inherit: "inherit",
    ...
    extend: {
      fontFamily: {
        ...
        inter: 'Inter, ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, "Noto Sans", sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji", sans-serif',
        unbounded: 'Unbounded, ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, "Noto Sans", sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji", sans-serif',
      },
      keyframes: {
        "fade-in": {
          "0%": {
