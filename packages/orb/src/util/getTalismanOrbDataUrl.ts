...
const platformLogoSvg = (platform: AccountPlatform): string => {
  switch (platform) {
    ...
    case "bitcoin":
      return '<g opacity="0.75" class="orb-type" transform="scale(2.4) translate(2.03 1.52)"><path d="M16.28 10.52c.21-1.4-.85-2.15-2.3-2.65l.47-1.89-1.15-.29-.46 1.84c-.3-.08-.61-.15-.92-.22l.46-1.85-1.15-.29-.47 1.89c-.25-.06-.5-.11-.73-.17v-.01l-1.58-.4-.31 1.23s.85.2.83.21c.47.12.55.43.54.67l-.54 2.15c.03.01.07.02.12.04l-.12-.03-.75 3.02c-.06.14-.2.35-.53.27.01.02-.83-.21-.83-.21l-.57 1.32 1.5.37c.28.07.55.14.82.21l-.47 1.91 1.15.29.47-1.89c.31.09.62.17.92.24l-.47 1.88 1.15.29.47-1.9c1.97.37 3.44.22 4.06-1.55.5-1.43-.02-2.25-1.06-2.79.75-.17 1.32-.67 1.47-1.69Zm-2.63 3.68c-.36 1.43-2.77.66-3.55.46l.63-2.53c.78.2 3.29.58 2.92 2.07Zm.36-3.7c-.33 1.3-2.33.64-2.98.48l.57-2.29c.65.16 2.75.47 2.41 1.81Z" fill="white"/></g>'
    default:
      return ""
  }
}
