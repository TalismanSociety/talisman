...
type SortBatchResults<TResult = unknown> = (a: TResult, b: TResult) => number
...
> = {
  ...
  wait?: number
  sort?: SortBatchResults<TReturnType[number]>
}
...
export function createTalismanBatchScheduler<TParameters, TReturnType extends readonly unknown[]>({
  fn,
  id,
  shouldSplitBatch,
  wait = 0,
