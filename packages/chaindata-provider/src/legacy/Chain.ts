...
export type LegacyChain = {
  id: LegacyChainId // The ID of this chain
  ...
  evmNetworks: Array<{ id: LegacyEvmNetworkId }>

  parathreads: Array<Pick<LegacyChain, "id" | "paraId" | "name">> | null // The parathreads of this relayChain, if some exist

  paraId: number | null // The paraId of this chain, if it is a parachain
  relay: Pick<LegacyChain, "id"> | null // The parent relayChain of this parachain, if this chain is a parachain
