...
import type { CustomEvmNetwork, EvmNetwork, EvmNetworkId } from "@talismn/chaindata-provider"
import type {
...
export interface EthMessages {
  ...
  "pri(eth.networks.subscribe)": [null, boolean, Array<EvmNetwork | CustomEvmNetwork>]
