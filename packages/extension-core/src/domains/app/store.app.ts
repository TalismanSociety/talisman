...
type CurrentMigration = {
  ...
  errors?: string[]
  acknowledgeRequest?: string // request to user, e.g. "Please wait while we migrate your data"
  acknowledged?: boolean // whether the user has acknowledged the migration request
}
