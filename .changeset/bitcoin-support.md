...
- `@talismn/bitcoin`: new package — Esplora REST client (failover, fee normalization), HD gap-limit scanner (dual tree, block-aware), and PSBT build/sign/finalize/verify (`@scure/btc-signer`, coin selection, taproot)
